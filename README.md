...
```
এবার দেখি কিভাবে মিডলওয়্যার রিকোয়েস্ট অবজেক্টে অ্যাক্সেস নেয়। এবং রিকোয়েস্ট মডিফাই করে।

```javascript
app.use(function(req, res, next){
    req.log = "I will be execute in 2nd middleware!"
    next();
});
...
```
> প্রথমে মিডলওয়্যার ফাংশন তৈরি হয়েছে। এরপর রিকোয়েস্ট এ নতুন অবজেক্ট প্রোপার্টি ক্রিয়েট করেছি। এবং সেটা দ্বিতীয় মিডলওয়্যারে নামের মাধ্যমে কন্সোলে দেখিয়েছি। এখানে `log` না দিয়ে আপনি যেকোনো কিছু দিতে পারেন। যা ই দিবেন `req` অবজেক্টে ইনক্লুড হয়ে যাবে। তো সহজেই বুঝতে পারলাম মিডলওয়্যার `req` অবজেক্টে access নিতে পারে এবং রিকোয়েস্ট মডিফাই করতে পারে।
